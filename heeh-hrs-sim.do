...
*** generate predicted probabilities and weights
mi est, saving(m1, replace): logit ba age i.rce i.fem i.fbr i.crur sib  ///
  i.clvg i.vet med fed i.cses i.cump i.mwrk csrh i.msch i.csmk i.psmk i.smp ///
  if coh == 1
qui mi predict ba1 using m1
qui mi xeq: gen pba1 = invlogit(ba1)
qui mi xeq: gen wt1 = 1/pba1 if ba
qui mi xeq: replace wt1 = 1/(1 - pba1) if !ba
...
qui mi xeq: gen wt2 = 1/pba2 if ba
qui mi xeq: replace wt2 = 1/(1 - pba2) if !ba
...
program SimDiD
  ...
  * fit primary DiD models and post results
  ...
  foreach x of varlist dsrh dadl {
    ...
    qui mi est (d: _b[1.cp#1.pstc] - _b[1.at#1.pstc]): reg `x' i.cp i.at     ///
	  ...
	  i.vet med fed i.cses i.cump i.mwrk i.csrh i.msch i.csmk i.psmk i.smp
    mat b1 = e(b_mi)
    mat b2 = e(b_Q_mi)
    mat v1 = e(V_mi)
    mat v2 = e(V_Q_mi)
